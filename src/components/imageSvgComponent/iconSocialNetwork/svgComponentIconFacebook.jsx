...
const SvgComponentIconFacebook = (props) => {
...
SvgComponentIconFacebook.propTypes = {
    state: PropTypes.bool,
   width:PropTypes.number,
   height:PropTypes.number,
};

export default SvgComponentIconFacebook;
